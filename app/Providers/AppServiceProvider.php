...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->singleton('ArieTimmerman\Laravel\SCIMServer\SCIMConfig', AMSSCIMConfig::class); // this overrides the default SCIM configuration with our own
