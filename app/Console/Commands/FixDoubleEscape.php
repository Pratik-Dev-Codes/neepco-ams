...
class FixDoubleEscape extends Command
{
     ...
     * @var string
     */
    protected $signature = 'neecpo_ams:unescape';
     ...
     * @var string
     */
    protected $description = 'This should be run to fix some double-escaping issues from earlier versions of NEEPCO AMS.';
