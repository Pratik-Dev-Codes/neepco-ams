...
class GeneratePersonalAccessToken extends Command
{
     ...
     * @var string
     */
    protected $signature = 'neecpo_ams:make-api-key 
     ...
     * @var string
     */
    protected $description = 'This console command allows you to generate Personal API tokens to be used with the NEEPCO AMS JSON REST API on behalf of a user.';
