...
class RestoreFromBackup extends Command
{
    ...
    protected $signature = 'neecpo_ams:restore 
     ...
     * @var string
     */
    protected $description = 'Restore from a previously created NEEPCO AMS backup file';
    ...
    public function handle()
    {
        ...
        if (strpos($sqlfiles[0], 'db-dumps') === false) {
            ...
            //older NEEPCO AMS installs don't have the db-dumps subdirectory component
        }
