...
class PaveIt extends Command
{
     ...
     * @var string
     */
    protected $signature = 'neecpo_ams:pave  {--force : Skip the interactive yes/no prompt for confirmation}';
