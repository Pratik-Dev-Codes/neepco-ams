...
class FixBulkAccessoryCheckinActionLogEntries extends Command
{
     ...
     * @var string
     */
    protected $signature = 'neecpo_ams:fix-bulk-accessory-action-log-entries {--dry-run : Run the sync process but don\'t update the database} {--skip-backup : Skip pre-execution backup}';
