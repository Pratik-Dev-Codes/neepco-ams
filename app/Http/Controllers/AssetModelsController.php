...
class AssetModelsController extends Controller
{
     ...
     */
    private function assignCustomFieldsDefaultValues(AssetModel|AMSModel $model, array $defaultValues): bool
    {
        $data = array();
        ...
        foreach ($model->fieldset->fields as $field) {
            $attributes[$field->db_column] = trim(preg_replace('/_+|neepco_ams|\d+/', ' ', $field->db_column));
        }
     ...
     *
     */
    private function removeCustomFieldsDefaultValues(AssetModel|AMSModel $model): void
    {
