...
class ActionlogsTransformer
{
    ...
    private function clean_field($value)
    {
        ...
        //
        // {"_neepco_amsright_sized_fault_tolerant_localareanetwo_1":
        // {"old":null,"new":{"value":"1579490695972","_neepco_amsnew_field_2":2,"_neepco_amsnew_field_3":"Monday, 20 January 2020 2:24:55 PM"}}
        ...
        if (($actionlog->log_meta) && ($actionlog->log_meta!='')) {
            ...
            if ($meta_array) {
                ...
                foreach ($meta_array as $fieldname => $fieldata) {
                    ...
                    if (str_starts_with($fieldname, '_neepco_ams')) {
