...
class MigrateMacAddress extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::table('assets', function (Blueprint $table) {
            $table->renameColumn('mac_address', '_neepco_amsmac_address');
        });

        // DB::statement("ALTER TABLE assets CHANGE mac_address _neepco_amsmac_address varchar(255)");
    ...
    public function down()
    {
        ...
        if (Schema::hasColumn('assets', '_neepco_amsmac_address')) {
            DB::statement('ALTER TABLE assets CHANGE _neepco_amsmac_address mac_address varchar(255)');
        }
    }
}
