        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 col-md-offset-4">
                    ...
                    @if (($AMSSettings->google_login=='1') && ($AMSSettings->google_client_id!='') && ($AMSSettings->google_client_secret!=''))
                    ...
                    <div class="box login-box">
                        ...
                        <div class="login-box-body">
                            <div class="row">
                                ...
                                @if ($AMSSettings->login_note)
                                    <div class="col-md-12">
                                        <div class="alert alert-info">
                                            {!!  Helper::parseEscapedMarkedown($AMSSettings->login_note)  !!}
                                        </div>
                                    </div>
                                @endif
                            ...
                            @if (!config('app.require_saml') && $AMSSettings->saml_enabled)
                            <div class="row">
                        ...
                        <div class="box-footer">
                            ...
                            @if ($AMSSettings->custom_forgot_pass_url)
                                <div class="col-md-12 text-right" style="padding-top: 15px;">
                                    <a href="{{ $AMSSettings->custom_forgot_pass_url  }}" rel="noopener">{{ trans('auth/general.forgot_password')  }}</a>
                                </div>
