                  ...
                  <div class="row">
                   ...
                   <!-- LDAP -->
                    ...
                    @if ($user->activated == '1')
                          ...
                          @if ((Auth::user()->isSuperUser()) && ($user->two_factor_active_and_enrolled()) && ($AMSSettings->two_factor_enabled!='0') && ($AMSSettings->two_factor_enabled!=''))
        ...
        <div class="tab-pane" id="licenses">
          ...
          <div class="table-responsive">
            <table
                    ...
                    data-sort-order="asc"
                    data-sort-name="name"
                    class="table table-striped ams-table table-hover"
                    data-export-options='{
            ...
            <table
              ...
              <tr>
                ...
                <th data-field="created_at" data-formatter="dateDisplayFormatter" data-sortable="true">{{ trans('general.date') }}</th>
                  ...
                  @if  ($AMSSettings->require_accept_signature=='1')
