...
@if ($AMSSettings->dashboard_message!='')
<div class="row">
    <div class="col-md-12">
        <div class="box">
            <!-- /.box-header -->
            <div class="box-body">
                <div class="row">
                    <div class="col-md-12">
                        {!!  Helper::parseEscapedMarkedown($AMSSettings->dashboard_message)  !!}
                    </div>
                </div>
            </div>
        </div>
...
<div class="row">
    <div class="col-md-6">
		...
		@if ((($AMSSettings->scope_locations_fmcs!='1') && ($AMSSettings->full_multiple_companies_support=='1')))
			 <!-- Companies -->	
			<div class="box box-default">
				<div class="box-header with-border">
