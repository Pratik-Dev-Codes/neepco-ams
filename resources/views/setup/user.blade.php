...
<form action="{{ route('setup.user.save') }}" method="POST">
  ...
  <div class="col-lg-12" style="padding-top: 20px;">
    ...
    <div class="row">
      <div class="form-group col-lg-12 required {{ $errors->has('site_name') ? 'error' : '' }}">
        ...
        <input class="form-control" placeholder="NEEPCO AMS Asset Management" required="" name="site_name" type="text" value="{{ old('site_name') }}">
  ...
  <div class="row">
    ...
    <div class="form-group col-lg-6{{$errors->has('default_currency') ? ' error' : ''}}">
      ...
      <input class="form-control" placeholder="INR" maxlength="3" style="width: 60px;" name="default_currency" type="text" id="default_currency" value="{{ old('default_currency') }}">
