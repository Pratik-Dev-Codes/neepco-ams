                        ...
                        <div class="row">
                            <div class="col-md-12 table-responsive" style="padding-top: 30px;">
                                <table data-pagination="true"
                                        ...
                                        id="upload-table"
                                        class="col-md-12 table table-striped ams-table">
                                                    ...
                                                    <td colspan="5">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-9 col-xs-12">
                                                                ...
                                                                />
                                                                    @if ($typeOfImport === 'asset' && $AMSSettings->auto_increment_assets == 0)
                                                                        <p class="help-block">
                                                            ...
                                                            <div class="form-group col-md-9 col-md-offset-3">
                                                                ...
                                                                @if ($typeOfImport === 'asset' && $AMSSettings->auto_increment_assets == 1 && $update)
                                                                    <p class="help-block">
