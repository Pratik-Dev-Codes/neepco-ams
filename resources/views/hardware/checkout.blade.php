                ...
                <form class="form-horizontal" method="post" action="" autocomplete="off">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group {{ $errors->has('note') ? 'error' : '' }}">
                            ...
                            <div class="col-md-8">
                                <textarea class="col-md-6 form-control" id="note" @required($AMSSettings->require_checkinout_notes)
                        ...
                        @if ($asset->requireAcceptance() || $asset->getEula() || ($AMSSettings->webhook_endpoint!=''))
                            <div class="form-group notification-callout">
                                <div class="col-md-8 col-md-offset-3">
                                    <div class="callout callout-info">
                                        ...
                                        @if ($AMSSettings->webhook_endpoint!='')
