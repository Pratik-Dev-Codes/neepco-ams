    ...
    $(document).ready(function() {
        ...
        $(add_button).click(function(e){ //on add input button click
            ...
            if (x < max_fields) {
                ...
                box_html += '<input type="text"  class="form-control" name="asset_tags[' + x + ']" value="{{ (($AMSSettings->auto_increment_prefix!='') && ($AMSSettings->auto_increment_assets=='1')) ? $AMSSettings->auto_increment_prefix : '' }}'+ auto_tag +'" required>';
                box_html += '</div>';
