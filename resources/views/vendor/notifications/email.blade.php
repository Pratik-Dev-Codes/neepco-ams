                        ...
                        <td style="{{ $style['email-masthead'] }}">
                            ...
                            @if (($AMSSettings->show_images_in_email=='1' ) && ($AMSSettings::setupCompleted()))
                                @php
                                    $logo = '';
                                    if ($AMSSettings->logo != ''){
                                        $logo = $AMSSettings->logo;
                                    }

                                    if ($AMSSettings->email_logo != ''){
                                        $logo = $AMSSettings->email_logo;
                                    }
                                @endphp
                            ...
                            <table style="{{ $style['email-body_inner'] }}" align="center" width="570" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="{{ $fontFamily }} {{ $style['email-body_cell'] }}">
                                        ...
                                        <!-- Salutation -->
                                        <p style="{{ $style['paragraph'] }}">
                                            Regards,<br>{{ $AMSSettings->site_name }}
                                        </p>
                            ...
                            <table style="{{ $style['email-footer'] }}" align="center" width="570" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="{{ $fontFamily }} {{ $style['email-footer_cell'] }}">
                                        <p style="{{ $style['paragraph-sub'] }}">
                                            &copy; {{ date('Y') }}
                                            <a style="{{ $style['anchor'] }}" href="{{ config('app.url') }}" target="_blank">{{ $AMSSettings->site_name }}</a>.
