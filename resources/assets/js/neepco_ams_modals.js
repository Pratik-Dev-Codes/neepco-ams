/* 
 * 
 * NEEPCO AMS Universal Modal support
 * 
 * Enables modal dialogs to create sub-resources throughout NEEPCO AMS
 * 
 */
...
$(function () {
  ...
  $('#createModal').on("show.bs.modal", function (event) {
      ...
      $('#createModal').load(link.attr('href'),function () {
        ...
        // This is a copy/paste of the code from neepco_ams.js, would be great to only have this in one place.
...
function formatDatalistSafe(datalist) {
    ...
    if (datalist.image) {
         ...
         * in NEEPCO AMS. If that changes, we would probably want to change
