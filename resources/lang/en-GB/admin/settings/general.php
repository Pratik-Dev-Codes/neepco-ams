...
'ldap_location_help'             => 'The Ldap Location field should be used if <strong>an OU is not being used in the Base Bind DN.</strong> Leave this blank if an OU search is being used.',
    ...
    'ldap_activated_flag_help'  => 'This value is used to determine whether a synced user can login to NEEPCO AMS. <strong>It does not affect the ability to check items in or out to them</strong>, and should be the <strong>attribute name</strong> within your AD/LDAP, <strong>not the value</strong>. <br><br>If this field is set to a field name that does not exist in your AD/LDAP, or the value in the AD/LDAP field is set to <code>0</code> or <code>false</code>, <strong>user login will be disabled</strong>. If the value in the AD/LDAP field is set to <code>1</code> or <code>true</code> or <em>any other text</em> means the user can log in. When the field is blank in your AD, we respect the <code>userAccountControl</code> attribute, which usually allows non-suspended users to log in.',
    ...
    'load_remote_help_text'		=> 'Uncheck this box if your install cannot load scripts from the outside internet. This will prevent NEEPCO AMS from trying load avatars from Gravatar or other outside sources.',
    ...
    'login_remote_user_custom_logout_url_help' => 'If a url is provided here, users will be redirected to this URL after the user logs out of NEEPCO AMS. This is useful to close the user sessions of your Authentication provider correctly.',
    ...
    'show_images_in_email_help'   => 'Uncheck this box if your NEEPCO AMS installation is behind a VPN or closed network and users outside the network will not be able to load images served from this installation in their emails.',
    'site_name'                 => 'Site Name',
    ...
    'ams_version'  			=> 'NEEPCO AMS version',
    'support_footer'            => 'Support Footer Links ',
    'support_footer_help'       => 'Specify who sees the links to the NEEPCO AMS Support info and Users Manual',
    'version_footer'            => 'Version in Footer ',
    'version_footer_help'       => 'Specify who can see the NEEPCO AMS version and build number.',
    ...
    'width_w'        => 'w',
    'height_h'        => 'h',
    'show_url_in_emails'                => 'Link to NEEPCO AMS in Emails',
    'show_url_in_emails_help_text'      => 'Uncheck this box if you do not wish to link back to your NEEPCO AMS installation in your email footers. Useful if most of your users never login. ',
    'text_pt'        => 'pt',
    ...
    'barcodes_help' => 'This will attempt to delete cached barcodes. This would typically only be used if your barcode settings have changed, or if your NEEPCO AMS URL has changed. Barcodes will be re-generated when accessed next.',
    ...
    'help_default_will_use' => '<code>:default</code> will use the value from <code>:setting_name</code>. <br>Note that the value of the barcodes must comply with the respective barcode spec in order to be successfully generated. Please see <a href="https://neepco-ams.readme.io/docs/barcodes">the documentation <i class="fa fa-external-link"></i></a> for more details. ',
    'asset_id'              => 'Asset ID',
    'data'               => 'Data',
    'default'               => 'Default',
    'none'                  => 'None',
