...
return array(
    ...
    'api_reference' => 'Please check the <a href="https://neepco-ams.readme.io/reference" target="_blank">API reference</a> to find specific API endpoints and additional API documentation.',
