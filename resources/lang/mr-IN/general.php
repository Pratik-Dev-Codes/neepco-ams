...
return [
    ...
    'importing'         	=> 'Importing',
    'importing_help'        => 'You can import assets, accessories, licenses, components, consumables, and users via CSV file. <br><br>The CSV should be comma-delimited and formatted with headers that match the ones in the <a href="https://neepco-ams.readme.io/docs/importing" target="_new">sample CSVs in the documentation</a>.',
    ...
    'webhook_test_msg'        => 'Oh hai! It looks like your :app integration with NEEPCO AMS is working!',
    ...
    'version' => 'Version',
    'build' => 'build',
    'footer_credit' => '<a target="_blank" href="https://github.com/Pratik-Dev-Codes/neepco-ams" rel="noopener">NEEPCO AMS</a> is open source software, made with <i class="fa fa-heart" aria-hidden="true" style="color: #a94442; font-size: 10px" /></i><span class="sr-only">love</span> by <a target="_blank" href="https://github.com/Pratik-Dev-Codes" rel="noopener">@Pratik-Dev-Codes</a> For <a target="_blank" href="https://neepco.co.in/" rel="noopener">NEEPCO Ltd.</a>  Version v1.0.16 - build 10016 (master)',
