...
NEEPCO_AMS_SH_URL= "https://github.com/Pratik-Dev-Codes/neepco-ams/blob/master/neepco_ams.sh"
...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "centos7" do |centos7|
    ...
    centos7.vm.provision :shell, :inline => "wget #{NEEPCO_AMS_SH_URL}"
    centos7.vm.provision :shell, :inline => "chmod 755 neepco_ams.sh"
  end
  ...
  config.vm.define "centos6" do |centos6|
    ...
    centos6.vm.provision :shell, :inline => "wget #{NEEPCO_AMS_SH_URL}"
    centos6.vm.provision :shell, :inline => "chmod 755 neepco_ams.sh"
  end
  ...
  config.vm.define "jessie" do |jessie|
    ...
    jessie.vm.provision :shell, :inline => "wget #{NEEPCO_AMS_SH_URL}"
    jessie.vm.provision :shell, :inline => "chmod 755 neepco_ams.sh"
  end
  ...
  config.vm.define "stretch" do |stretch|
    ...
    stretch.vm.provision :shell, :inline => "wget #{NEEPCO_AMS_SH_URL}"
    stretch.vm.provision :shell, :inline => "chmod 755 neepco_ams.sh"
  end
  ...
  config.vm.define "fedora27" do |fedora27|
    ...
    fedora27.vm.provision :shell, :inline => "wget #{NEEPCO_AMS_SH_URL}"
    fedora27.vm.provision :shell, :inline => "chmod 755 neepco_ams.sh"
  end
    ...
    fedora26.vm.provision :shell, :inline => "wget #{NEEPCO_AMS_SH_URL}"
    fedora26.vm.provision :shell, :inline => "chmod 755 neepco_ams.sh"
  end
