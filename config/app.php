...
return [
   ...
   | NEEPCO AMS within an I-Frame, which is normally disabled by default for
   ...
   */
    ...
    */
    ...
    | version of NEEPCO AMS with limited functionality to prevent demo abuse.
    |
    */
    ...
    */
    ...
    'providers' => [
        ...
        App\Providers\AMSTranslationServiceProvider::class, //we REPLACE the default Laravel translator with our own
